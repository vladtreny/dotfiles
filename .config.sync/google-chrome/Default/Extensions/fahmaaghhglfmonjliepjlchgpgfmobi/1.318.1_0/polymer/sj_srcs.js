...
Polymer({
      ...
      properties: {
        /**
         * The Animation Player object for the element.
        ...
        /**
         * The timing animation config for the element.
         * See: https://developer.mozilla.org/en-US/docs/Web/API/Web_Animations_API/Animation_timing_options
         * @private {!AnimationEffectTimingProperties}
         */
        timing_: {
          type: Object,
          value: function() {
        ...
        /**
         * The KeyframEffects for the first rectangle.
         * See: https://developer.mozilla.org/en-US/docs/Web/API/KeyframeEffect/KeyframeEffect
        ...
        keyframes1_: {
          ...
          value: function() {
            return [
                ...
                {transform: "scaleY(0.258)"},
                {transform: "scaleY(0.468)"},
                {transform: "scaleY(0.661)"},
                {transform: "scaleY(0.855)"},
                {transform: "scaleY(0.806)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.709)"},
                {transform: "scaleY(0.565)"},
                {transform: "scaleY(0.645)"},
                {transform: "scaleY(0.661)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.806)"},
                {transform: "scaleY(0.854)"},
                {transform: "scaleY(0.823)"},
                {transform: "scaleY(0.774)"},
                {transform: "scaleY(0.726)"},
                {transform: "scaleY(0.694)"},
                {transform: "scaleY(0.726)"},
                {transform: "scaleY(0.774)"},
                {transform: "scaleY(0.823)"},
                {transform: "scaleY(0.855)"},
        ...
        /**
         * The KeyframEffects for the second rectangle.
         * See: https://developer.mozilla.org/en-US/docs/Web/API/KeyframeEffect/KeyframeEffect
         * @private {!Array.<!Object>}
         */
        keyframes2_: {
          ...
          value: function() {
            return [
                {transform: "scaleY(0.871)"},
                {transform: "scaleY(0.823)"},
                {transform: "scaleY(0.790)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.726)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.790)"},
                {transform: "scaleY(0.823)"},
                {transform: "scaleY(0.887)"},
                {transform: "scaleY(0.839)"},
                {transform: "scaleY(0.871)"},
                {transform: "scaleY(0.726)"},
                {transform: "scaleY(0.548)"},
                ...
                {transform: "scaleY(0.790)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.710)"},
                {transform: "scaleY(0.613)"},
                {transform: "scaleY(0.742)"},
                {transform: "scaleY(0.823)"}
            ];
          }
        },
        ...
        /**
         * The KeyframEffects for the third rectangle.
         * See: https://developer.mozilla.org/en-US/docs/Web/API/KeyframeEffect/KeyframeEffect
         * @private {!Array.<!Object>}
         */
        keyframes3_: {
          ...
          value: function() {
            return [
                ...
                {transform: "scaleY(0.629)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.887)"},
                {transform: "scaleY(1)"},
                {transform: "scaleY(0.903)"},
                {transform: "scaleY(0.742)"},
                {transform: "scaleY(0.613)"},
                {transform: "scaleY(0.516)"},
                {transform: "scaleY(0.452)"},
                {transform: "scaleY(0.339)"},
                {transform: "scaleY(0.516)"},
                {transform: "scaleY(0.677)"},
                {transform: "scaleY(0.758)"},
                {transform: "scaleY(0.839)"},
                {transform: "scaleY(0.790)"},
                {transform: "scaleY(0.742)"},
      ...
      /**
       * Starts and stops the animation based on the active state of the equalizer.
      ...
      activeChanged_: function(active) {
        ...
        if (active) {
          if (!this.animation_) {
            var keyframeEffects = [
              new KeyframeEffect(this.$.r1, this.keyframes1_, this.timing_),
              new KeyframeEffect(this.$.r2, this.keyframes2_, this.timing_),
              new KeyframeEffect(this.$.r3, this.keyframes3_, this.timing_),
            ];
            var group = new GroupEffect(keyframeEffects);
            this.animation_ = document.timeline.play(group);
          }
...
Polymer({
      ...
      properties: {
        ...
        /**
         * The color of the icon and equalizer. This maps to --sj-play-button-icon-color.
         * @type {string}
         */
        iconColor: {
          type: String,
      ...
      /**
       * Computes the icon for the current playback state.
       * @param {string} playbackState
       * @param {boolean} loading
       * @private
       */
      computeIcon_: function(playbackState, loading) {
        return loading || this.isPaused() ? 'av:pause' : 'sj:play-arrow';
      },

      /**
       * Computes the icon shown when hovering or focusing the button.
       * @param {boolean} playing
       * @private
       */
      computeHoverIcon_: function(playing) {
        return this.isPlaying() ? 'av:pause' : 'sj:play-arrow';
      },
...
Polymer({
      ...
      properties: {
        ...
        /**
         * The primary color of the card image.
         * @type {string}
         */
        primaryColor: {
          type: String
        ...
        /**
         * Whether to hide the context menu button.
         * @type {boolean}
         */
        noMenu: {
          type: Boolean,
        ...
        /**
         * The handler for focus and blur events, bound to the element's scope.
         * @private {function(!FocusEvent):void} event
         */
        boundFocusBlurHandler_: {
          type: Function,
          value: function() {
            return this.focusBlurHandler_.bind(this);
          }
        },
      ...
      createRipple_: function(event) {
        // Don't ripple for clicks on the play button.
        if (Polymer.dom(event).localTarget == this.$.playButton) {
          return;
        }
...
Polymer({
      ...
      /**
       * Updates the styling of the selected layer.
       * @param {number} selected
       * @private
       */
      selectedChanged_: function(selected) {
        var layers = this.getContentChildNodes('#layers');
        layers.forEach(function(layer, index) {
          this.toggleClass('selected', index == selected, layer);
        }, this);
      },
    });
Polymer({
      ...
      updateBreakpoints_: function() {
        var modules = this.getContentChildNodes('#modules');
      ...
      /**
       * Monitors changes to the list of modules and updates the page indicator.
       * @private
       */
      modulesChanged_: function() {
        var modules = this.getContentChildNodes('#modules');
        Polymer.dom(this.$.pageIndicator).innerHTML = '';

        modules.forEach(function(module) {
          var anchor = document.createElement('a');
          var span = document.createElement('span');
          span.textContent = Polymer.dom(module.$.moduleTitle).getDistributedNodes()[0].textContent;
          anchor.appendChild(span);
          Polymer.dom(this.$.pageIndicator).appendChild(anchor);
        }, this);
      },
      ...
      smoothScroll_: function() {
        ...
        var selectedModule = this.getContentChildNodes('#modules')[this.$.pageIndicator.selected];
        ...
        var effect = new KeyframeEffect(this.scrollTarget, function(timeFraction, target, effect) {
          timeFraction = timeFraction || 1;
          target.scrollTop = startingScrollTop + (timeFraction * delta);
...
Polymer({
      ...
      properties: {
        ...
        // See skyjam.FrontendServiceProto.QuerySuggestionData.SuggestionType.
        suggestionType: {
          type: Number,
          value: 0
        },
...
Polymer({
  ...
  listeners: {
    ...
    'suggestionList.click': 'onSuggestionClick_',
  ...
  properties: {
     ...
     * @type {!Array<!skyjam.FrontendServiceProto.QuerySuggestionData>}
     */
    suggestions: {
      type: Array,
      value: [],
   ...
   * @param {!skyjam.FrontendServiceProto.QuerySuggestionData} suggestion
   * @return {string}
   * @private
   */
  ...
  computeSuggestHtml_: function(suggestion) {
    // TODO(b/23588410): Use Soy to generate this once compilation is working.
  ...
  computeSuggestIcon_: function(suggestion) {
    switch (suggestion.getSuggestionType()) {
      // TODO(b/23588410): Reference the real enum once compilation is working.
      // QuerySuggestionData.SuggestionType.SUGGESTION_USER_HISTORICAL
      case 2:
        return 'history';
      default:
        return 'search';
  ...
  suggestionsChanged_: function() {
    // Cap the number of suggestions to 5.
    if (this.suggestions.length > 5) {
      this.splice('suggestions', 5, this.suggestions.length);
    }
    this.clearSelected_();
    this.async(function() {
      this.suggestionElements_ = Polymer.dom(this.$.suggestionList)
          .querySelectorAll('sj-search-suggestion');
      this.animationConfig.suggestions.nodes = this.suggestionElements_;
      this.setAttribute('num-suggestions', this.suggestions.length);
    });
  },
  ...
  querySelected_: function(event) {
    ...
    if (this.currentlySelected_) {
      this.fire('suggest-query', {
        query: this.currentlySelected_.query,
        originalQuery: this.$.input.value,
        position: this.currentlySelected_.position,
        suggestionType: this.currentlySelected_.suggestionType
      });
    } else {
      var query = this.$.input.value.trim();
  ...
  open: function() {
    ...
    // TODO(b/23588410): Reference GSS constant once compilation is working.
...
window.MusicBehaviors = window.MusicBehaviors || {};
   ...
   * @polymerBehavior
   */
  MusicBehaviors.BackgroundBlendBehavior = {
    ...
    properties: {
      ...
      /**
       * The background-blend-mode as a CSS <blend-mode>.
       * @type {string}
       */
      backgroundBlendMode: {
        type: String,
    ...
    observers: [
      'updateBackgroundStyles_(backgroundImage, backgroundColor, backgroundBlendMode)'
    ],

    /**
     * Updates the background styling.
     * @param {string} backgroundImage
     * @param {string} backgroundColor
     * @param {string} backgroundBlendMode
     * @private
     */
    updateBackgroundStyles_: function(backgroundImage, backgroundColor, backgroundBlendMode) {
      this.style.backgroundImage = 'url(' + backgroundImage + ')';
      this.style.backgroundColor = backgroundColor;
      this.style.backgroundBlendMode = backgroundBlendMode;
    },
  };
Polymer({
      is: 'sj-square-hero-layer',
